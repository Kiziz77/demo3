    ...
    <div v-if="showIndexFlag">
      ...
      <el-table :data="dataList" style="width: 100%" @selection-change="handleSelectionChange" border stripe>
        <el-table-column type="selection" width="55" header-align="center" align="center" />
              <el-table-column prop="customerName" label="客户姓名" header-align="center" align="center"></el-table-column>
              ...
              <el-table-column prop="quantity" label="购买数量" header-align="center" align="center"></el-table-column>
              <el-table-column prop="orderTime" label="订单时间" header-align="center" align="center"></el-table-column>
...
// 获取数据列表
const getDataList = () => {
  request.post("customerOrder/page", params.value).then(({ data }) => {
...
const handleBatchDelete = () => {
  ...
  ElMessageBox.confirm("确定要删除选中的信息吗?", "提示", {
    ...
    .then(() => {
      ...
      request.post("customerOrder/del/batch", ids).then(() => {
...
const handleDelete = (row) => {
  ElMessageBox.confirm(`确定要删除该信息吗?`, "提示", {
    ...
    .then(() => {
      request.delete(`customerOrder/del/` + row.id).then(() => {
        ElMessage.success("删除成功");
        getDataList();
      });
    })
