  ...
  <div class="module-container">
    <div v-if="showIndexFlag">
      ...
      <div class="filter-container">
        <el-input v-model="params.customerName" placeholder="请输入客户姓名" class="filter-item" clearable />
        <el-input v-model="params.phone" placeholder="请输入联系电话" class="filter-item" clearable />
      ...
      <el-table :data="dataList" style="width: 100%" @selection-change="handleSelectionChange" border stripe>
        <el-table-column type="selection" width="55" header-align="center" align="center" />
            ...
            <el-table-column prop="reserveQuantity" label="预约数量" header-align="center" align="center" />
            <el-table-column prop="reserveTime" label="预约时间" header-align="center" align="center" />
...
// 获取数据列表
const getDataList = () => {
  request.post("drugReservation/page", params.value).then(({ data }) => {
...
const handleBatchDelete = () => {
  ...
  ElMessageBox.confirm("确定要删除选中的信息吗?", "提示", {
    ...
    .then(() => {
      ...
      request.post("drugReservation/del/batch", ids).then(() => {
...
const handleDelete = (row) => {
  ElMessageBox.confirm(`确定要删除该信息吗?`, "提示", {
    ...
    .then(() => {
      request.delete(`drugReservation/del/` + row.id).then(() => {
        ElMessage.success("删除成功");
        getDataList();
      });
    })
