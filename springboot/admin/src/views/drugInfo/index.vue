  ...
  <div class="module-container">
    <div v-if="showIndexFlag">
      ...
      <div class="filter-container">
        <el-input v-model="params.drugName" placeholder="请输入药品名称" class="filter-item" clearable />
        <el-input v-model="params.manufacturer" placeholder="请输入生产商" class="filter-item" clearable />
      ...
      <el-table :data="dataList" style="width: 100%" @selection-change="handleSelectionChange" border stripe>
        <el-table-column type="selection" width="55" header-align="center" align="center" />
            <el-table-column prop="drugName" label="药品名称" header-align="center" align="center" />
            <el-table-column prop="specification" label="规格" header-align="center" align="center" />
            <el-table-column prop="manufacturer" label="生产商" header-align="center" align="center" />
            <el-table-column prop="approvalNumber" label="批准文号" header-align="center" align="center" />
...
// 获取数据列表
const getDataList = () => {
  request.post("drugInfo/page", params.value).then(({ data }) => {
...
const handleBatchDelete = () => {
  ...
  ElMessageBox.confirm("确定要删除选中的信息吗?", "提示", {
    ...
    .then(() => {
      ...
      request.post("drugInfo/del/batch", ids).then(() => {
...
const handleDelete = (row) => {
  ElMessageBox.confirm(`确定要删除该信息吗?`, "提示", {
    ...
    .then(() => {
      request.delete(`drugInfo/del/` + row.id).then(() => {
        ElMessage.success("删除成功");
        getDataList();
      });
    })
