  ...
  <div class="module-container">
    <div v-if="showIndexFlag">
      ...
      <div class="filter-container">
        ...
        <el-input v-model="params.batchNumber" placeholder="请输入批次号" class="filter-item" clearable />
        <el-input v-model="params.quantity" placeholder="请输入当前数量" class="filter-item" clearable />
      ...
      <el-table :data="dataList" style="width: 100%" @selection-change="handleSelectionChange" border stripe>
        <el-table-column type="selection" width="55" header-align="center" align="center" />
              ...
              <el-table-column prop="batchNumber" label="批次号" header-align="center" align="center"></el-table-column>
              <el-table-column prop="storageTime" label="入库时间" header-align="center" align="center"></el-table-column>
              <el-table-column prop="expiryDate" label="有效期至" header-align="center" align="center"></el-table-column>
              <el-table-column prop="quantity" label="当前数量" header-align="center" align="center"></el-table-column>
                <el-table-column prop="purchaseId" label="采购记录ID" header-align="center" align="center">
                  <template #default="{ row }" >
                    {{row.t3Purchaseid}}
                  </template>
                </el-table-column>
...
// 获取数据列表
const getDataList = () => {
  request.post("inventory/page", params.value).then(({ data }) => {
...
const handleBatchDelete = () => {
  ...
  ElMessageBox.confirm("确定要删除选中的信息吗?", "提示", {
    ...
    .then(() => {
      ...
      request.post("inventory/del/batch", ids).then(() => {
...
const handleDelete = (row) => {
  ElMessageBox.confirm(`确定要删除该信息吗?`, "提示", {
    ...
    .then(() => {
      request.delete(`inventory/del/` + row.id).then(() => {
        ElMessage.success("删除成功");
        getDataList();
      });
    })
