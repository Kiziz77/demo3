  ...
  <div class="module-container">
    <div v-if="showIndexFlag">
      ...
      <div class="filter-container">
        <el-input v-model="params.productsName" placeholder="请输入商品名称" class="filter-item" clearable />
        <el-input v-model="params.brand" placeholder="请输入商品品牌" class="filter-item" clearable />
      ...
      <el-table :data="dataList" style="width: 100%" @selection-change="handleSelectionChange" border stripe>
        <el-table-column type="selection" width="55" header-align="center" align="center" />
            <el-table-column prop="productsName" label="商品名称" header-align="center" align="center" />
            <el-table-column prop="brand" label="商品品牌" header-align="center" align="center" />
            <el-table-column prop="stockQuantity" label="库存数量" header-align="center" align="center" />
            <el-table-column prop="price" label="商品价格" header-align="center" align="center" />
            <el-table-column prop="description" label="商品描述描述" header-align="center" align="center" />
            <el-table-column prop="createTime" label="上架时间" header-align="center" align="center" />

            <el-table-column prop="imageUrl" label="商品图片" header-align="center" align="center">
              <template #default="{ row }">
                <el-image v-if="row.imageUrl" style="width: 100px; height: 100px" :src="row.imageUrl.split(',')[0]" fit="cover" />
...
// 获取数据列表
const getDataList = () => {
  request.post("products/page", params.value).then(({ data }) => {
...
const handleBatchDelete = () => {
  ...
  ElMessageBox.confirm("确定要删除选中的信息吗?", "提示", {
    ...
    .then(() => {
      ...
      request.post("products/del/batch", ids).then(() => {
...
const handleDelete = (row) => {
  ElMessageBox.confirm(`确定要删除该信息吗?`, "提示", {
    ...
    .then(() => {
      request.delete(`products/del/` + row.id).then(() => {
        ElMessage.success("删除成功");
        getDataList();
      });
    })
