  ...
  <div class="module-container">
    <div v-if="showIndexFlag">
      ...
      <div class="filter-container">
              <module-select v-model="params.supplierId" placeholder="请选择供应商ID" class="filter-item" titleName="supplierName" url="/supplierInfo/loadAll" optionKey="id"></module-select>
              <module-select v-model="params.drugId" placeholder="请选择药品ID" class="filter-item" titleName="drugName" url="/drugInfo/loadAll" optionKey="id"></module-select>
        <el-date-picker v-model="params.purchaseTime" type="date" value-format="YYYY-MM-DD" class="filter-item"/>
      ...
      <el-table :data="dataList" style="width: 100%" @selection-change="handleSelectionChange" border stripe>
        <el-table-column type="selection" width="55" header-align="center" align="center" />
                <el-table-column prop="supplierId" label="供应商ID" header-align="center" align="center">
              ...
              <el-table-column prop="purchaseQuantity" label="采购数量" header-align="center" align="center"></el-table-column>
              <el-table-column prop="purchaseTime" label="采购时间" header-align="center" align="center"></el-table-column>
              <el-table-column prop="purchaseId" label="采购记录ID" header-align="center" align="center"></el-table-column>
              <el-table-column prop="purchaseUnitPrice" label="采购单价" header-align="center" align="center"></el-table-column>
...
// 获取数据列表
const getDataList = () => {
  request.post("purchaseRecord/page", params.value).then(({ data }) => {
...
const handleBatchDelete = () => {
  ...
  ElMessageBox.confirm("确定要删除选中的信息吗?", "提示", {
    ...
    .then(() => {
      ...
      request.post("purchaseRecord/del/batch", ids).then(() => {
...
const handleDelete = (row) => {
  ElMessageBox.confirm(`确定要删除该信息吗?`, "提示", {
    ...
    .then(() => {
      request.delete(`purchaseRecord/del/` + row.id).then(() => {
        ElMessage.success("删除成功");
        getDataList();
      });
    })
